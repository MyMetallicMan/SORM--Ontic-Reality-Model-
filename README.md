...
## Permanent Archiving with Zenodo

To ensure this work is permanently preserved and citable, this repository is paired with Zenodo for long-term archiving and Digital Object Identifier (DOI) assignment.
...
This process ensures that even if GitHub changes or disappears, the work remains accessible through Zenodo.
...
├── bridges-overview.md               # Overview of worldview bridges
├── LICENSE                           # CC BY-SA 4.0
...
│   └── section-33-The-Experience-of-Consciousness-at-Death.md
├── bridges/
│   ├── Agnosticism-Atheism bridge.md
│   ├── Baha'i bridge.md
│   ├── Buddhism bridge.md
│   ├── Christian bridge.md
│   ├── Confucianism bridge.md
│   ├── Daoism bridge.md
│   ├── Existentialism-Absurdism bridge.md
│   ├── Golden-Dawn bridge.md
│   ├── Hinduism bridge.md
│   ├── Islam bridge.md
│   ├── Jainism bridge.md
│   ├── Judaism bridge.md
...
│   ├── New Age bridge.md
│   ├── Psychedelic-Science bridge.md
│   ├── Science (Empirical) bridge.md
│   ├── Secular-Humanism bridge.md
│   ├── Shinto bridge.md
│   ├── Sikhism bridge.md
│   ├── Stoicism bridge.md
│   ├── Thelema-Crowley bridge.md
│   └── Witchcraft-Wicca bridge.md
